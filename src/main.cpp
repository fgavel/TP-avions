...
{
    // Initialisation avions (pas besoin des symboles, le symbole est inclus dans le constructeur AvionAmi et Avion Ennemi)
...
/* SPACESHIPS	*/
	...
	osg::ref_ptr<osg::Node> xWing (osgDB::readNodeFile("/home/user/avions/models/star wars x-wing/star wars x-wing.3ds"));
	osg::ref_ptr<osg::Node> tFighter (osgDB::readNodeFile("/home/user/avions/models/vador/TF_3ds3d.3ds"));
